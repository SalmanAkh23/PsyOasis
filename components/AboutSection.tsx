...
// Icon placeholders â€“ simple SVGs for visual consistency
const icons = {
  confidentiality: (
    <svg xmlns="http://www.w3.org/2000/svg" className="w-6 h-6 text-[#315ab4]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
  ...
  professional: (
    <svg xmlns="http://www.w3.org/2000/svg" className="w-6 h-6 text-[#006d31]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
...
const highlights = [
  ...
  {
    title: 'Pendekatan Humanâ€‘Centered',
...
export default function AboutSection() {
  return (
    <section id="tentang-kami" className="py-20 relative overflow-hidden">
      ...
      <div className="absolute inset-0 bg-gradient-to-b from-transparent via-[#006d31]/4 to-transparent pointer-events-none" />
      ...
      <div className="max-w-6xl mx-auto px-6 relative z-10">
        ...
        <div className="text-center mb-12">
          ...
          <h2 className="text-3xl md:text-4xl font-extrabold font-space text-[#1a1c1e]">
            Kami Percaya Setiap Orang Berhak Mendapatkan Dukungan yang Tepat
          </h2>
          <p className="text-[#1a1c1e]/60 text-base md:text-lg font-light mt-4 max-w-2xl mx-auto">
        ...
        {/* Highlight Cards â€“ twoâ€‘column layout on desktop */}
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-12">
          {highlights.map((item, idx) => (
            <div key={idx} className="bg-white/65 backdrop-blur-sm p-6 rounded-2xl border border-[#006d31]/15 hover:border-[#315ab4]/25 hover:bg-white/80 hover:shadow-[0_8px_30px_rgba(74,122,150,0.10)] transition-all duration-300 shadow-sm flex flex-col">
              <div className="w-10 h-10 rounded-xl bg-[#F7F9F6] flex items-center justify-center mb-4 border border-[#006d31]/20 shadow-sm">
                {item.icon}
              </div>
              <h4 className="text-lg font-bold text-[#1a1c1e] font-space mb-2">
                {item.title}
              </h4>
              <p className="text-sm text-[#1a1c1e]/60 leading-relaxed font-light">
                {item.desc}
              </p>
            </div>
          ))}
        ...
        <div className="text-center">
          <blockquote className="text-[#1a1c1e]/65 italic text-base md:text-lg font-medium max-w-2xl mx-auto border-l-4 border-[#006d31]/40 pl-6 text-left">
